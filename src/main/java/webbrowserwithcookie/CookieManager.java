...
public class CookieManager {
    ...
    private static void createCookies(String mail, String name, String password, int i) {
        ...
        try {
            ...
            WebElement usernameField = helper.waitForElement(By.cssSelector("[autocapitalize='sentences'][autocomplete='username'][autocorrect='on'][name='text'][spellcheck='true']"));
            if (usernameField != null) usernameField.sendKeys(mail);
            ...
            if (nameField != null) {
                ...
                if (nextField != null) nextField.click();
            }

            WebElement passwordField = helper.waitForElement(By.cssSelector("[name=\"password\"][spellcheck=\"true\"]"));
            if (passwordField != null) passwordField.sendKeys(password);

            WebElement loginButton = helper.waitForElement(By.cssSelector("[data-testid=\"LoginForm_Login_Button\"][type=\"button\"]"));
