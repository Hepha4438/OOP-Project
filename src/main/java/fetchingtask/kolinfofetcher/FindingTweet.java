...
public class FindingTweet implements FindingPost {
    ...
    public Set<String> findingPost(String KOLLink){
        ...
        while (true){
            ...
            helper.fetcher(tweetLinks, maxPostPerKOL, By.cssSelector("[role='article']"), By.xpath(".//a[contains(@href,'/status/')]"));
    ...
    public void saveErrorKOL(String KOLLink){
        System.out.println("Không tìm được bài post của: " + KOLLink);
        List<String> errorLinks = loadFile(fileErrorName,new TypeToken<List<String>>() {}.getType());
        if(errorLinks==null){
    ...
    public Set<String> findingCommenter(String tweetLink, String KOLLink) {
        ...
        while (true) {
            ...
            helper.fetcher(commenterLinks,maxCommentPerTweet,By.cssSelector("[role='article']"),By.cssSelector("a[href*='/']"));
    ...
    public Set<String> findingReposter(String tweetLink, String KOLLink) {
        ...
        while (true) {
            ...
            helper.fetcher(reposterLinks, maxRepostPerTweet, By.cssSelector("[data-testid='UserCell'][role='button']"),By.tagName("a"));
    ...
    public void runTask() {
        ...
        Map<String,Integer> savedKOLMap = loadFile(FilteringXKOL.outputFilePath,new TypeToken<LinkedHashMap<String,Integer>>(){}.getType());
        if (savedKOLMap!=null){
        ...
        //Duyệt từng KOLLink và các tweet, các comment trong từng tweet của từng KOLLink
        while (iterator.hasNext()) {
            ...
            if (!tweetLinks.isEmpty()) {
                ...
                for (Tweet checkedTweet : tweetsOFKOL) {
                    saveObject(checkedTweet,outputFilePath,new TypeToken<LinkedHashSet<Tweet>>() {}.getType());
                }
            }
