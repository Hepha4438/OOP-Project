...
public class XPageRankAlgorithm implements Algorithm {
	...
	@Override
	public void ranking() {
		Type setType = new TypeToken<LinkedHashSet<KOL>>() {
		}.getType();
		Type setType2 = new TypeToken<LinkedHashSet<Tweet>>() {
		}.getType();
		...
		System.out.println(builtGraph.getEdgeCount());
		System.out.println(builtGraph.getVertexCount());
	}
}
